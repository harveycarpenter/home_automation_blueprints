...
Control up to 4 scenes (single tap) with optional double-tap scenes, plus dimming on rotate. No helpers, timestamps, or additional entities are required — just import the blueprint and configure the inputs.
